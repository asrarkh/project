    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
            <div class="container" style="padding:3%;" >
                <form action="/manager/jobs/{{$job->id}}/update" method="POST" style="width: 50%;margin-left:auto;margin-right:auto">
                    @csrf
                    @method('PUT')
                        ...
                        <select name="is_active" class="form-control" value="{{$job->is_active}}">
