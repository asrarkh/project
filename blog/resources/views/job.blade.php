  ...
  <body>
    <div class="testbox">
      <form action="{{route('project')}}">
        ...
        <div class="item">
          <label for="major">التخصص<span>*</span></label>
        ...
        <div class="item">
          <p>اختيار الوظيفة<span>*</span></label></p>
          <select>
            <option selected value="" disabled selected ></option>
            <option value="course-type" >ذكاء اصطناعي</option>
            <option value="short-courses">مطور ويب</option>
            <option value="featured-courses">امن سيبراني</option>
            <option value="undergraduate">هندسة برمجيات</option>
          </select>
        </div>
        <div class="item">
          <label for="cv">السيرة الذاتية<span>*</span></label>
